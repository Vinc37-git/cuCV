...
void MatTest::testOnes() {
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==1);
        CPPUNIT_ASSERT(A16U.mData[i]==1);
        CPPUNIT_ASSERT(A64F.mData[i]==1);
    }
}
...
void MatTest::testEye() {
    ...
    for (size_t i=0; i<8; i++) {
        CPPUNIT_ASSERT(A8U_eye.mData[i]==testData[i]);
        CPPUNIT_ASSERT(A16U_eye.mData[i]==testData[i]);
        CPPUNIT_ASSERT(A64F_eye.mData[i]==testData[i]);
    }
}
...
void MatTest::testAdd() {
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==4);
        CPPUNIT_ASSERT(A16U.mData[i]==5);
        CPPUNIT_ASSERT(A64F.mData[i]==6);
    }
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==8);
        CPPUNIT_ASSERT(C16U.mData[i]==6);
        CPPUNIT_ASSERT(A64F.mData[i]==4);
    }
}
...
void MatTest::testMul() {
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==3);
        CPPUNIT_ASSERT(A16U.mData[i]==4);
        CPPUNIT_ASSERT(A64F.mData[i]==0.5);
    }
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==9);
        CPPUNIT_ASSERT(C16U.mData[i]==20);
        CPPUNIT_ASSERT(A64F.mData[i]==0.7 * 0.7 * 0.2 * 0.2);
    }
}
...
void MatTest::testDif() {
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==128);
        CPPUNIT_ASSERT(A16U.mData[i]==32768);
        CPPUNIT_ASSERT(A64F.mData[i]==0.7);
    }
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==0);
        CPPUNIT_ASSERT(C16U.mData[i]==30000);
        CPPUNIT_ASSERT(A64F.mData[i]==-1.4);
    }
}
...
void MatTest::testDiv() {
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==127);
        CPPUNIT_ASSERT(A16U.mData[i]==32767);
        CPPUNIT_ASSERT(A64F.mData[i]==0.5);
    }
    ...
    for (size_t i=0; i<N*N*N; i++) {
        CPPUNIT_ASSERT(A8U.mData[i]==1);
        CPPUNIT_ASSERT(C16U.mData[i]==32767/3);
        CPPUNIT_ASSERT(A64F.mData[i]==0.5 / 0.1 / 0.1 / 0.7 / 0.7);
    }
}
